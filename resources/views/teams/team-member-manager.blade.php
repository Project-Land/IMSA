                            ...
                            <tr wire:key="{{ $user->id }}">
                                ...
                                <td class="px-3 py-2 whitespace-no-wrap">
                                    <div class="w-full sm:w-28">
                                        ...
                                        <span class="cursor-pointer ml-2 text-sm text-gray-400"
                                            onclick="toggleModal('{{ $user->id }}', '{{ $user->membership->role }}')">
                                ...
                                <td class="px-3 py-2 whitespace-no-wrap">
                                    ...
                                    <span class="cursor-pointer ml-2 text-sm text-gray-400"
                                        @if(Laravel\Jetstream\Jetstream::findRole($user->membership->role)->name !=
                                        "Super Admin" && $user->id != $this->user->id)
                                        wire:click="manageRole('{{ $user->id }}')" @endif>
