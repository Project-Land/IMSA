            ...
            <div class="card">
                <div class="card-header">
                    <div class="">
                        ...
                        @endcan
                        <a
                            href="{{route('statement-of-applicability.print')}}" target="_blank" class="inline-block float-right text-xs md:text-base bg-green-500 hover:bg-green-700 text-white hover:no-underline rounded py-2 px-3"><i class="fas fa-print"></i> {{ __('Odštampaj') }}
                        </a>
