                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <a class="inline-block bg-blue-500 hover:bg-blue-700 text-white hover:no-underline rounded py-2 px-3" href="{{ route('trainings.create') }}"><i class="fas fa-plus"></i> Dodaj obuku</a>
                            @endcan
                        </div>
                        <div class="col-sm-8">
