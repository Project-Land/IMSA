		...
		<form action="{{ route('complaints.update', $complaint->id) }}" method="POST" autocomplete="off" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
			...
			<div class="{{ $complaint->accepted == 1 ? "" : "d-none" }}" id="complaint_accepted">
				...
				<div class="mb-4">
					...
					<input type="text" class="appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="responsible_person" name="responsible_person" value="{{ $complaint->responsible_person }}" oninvalid="this.setCustomValidity('Popunite polje')" oninput="this.setCustomValidity('')" {{ $complaint->accepted ? 'required':'' }}>
				...
				<div class="mb-4">
					...
					<input type="text" class="appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="way_of_solving" name="way_of_solving" value="{{ $complaint->way_of_solving }}" oninvalid="this.setCustomValidity('Popunite polje')" oninput="this.setCustomValidity('')" {{ $complaint->accepted  ? 'required':'' }}>
