<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ session('standard_name') }} - {{ __('Zapisnik sa preispitivanja')}} - {{__('Kreiranje') }}
        </h2>
    </x-slot>
    ...
    <div class="mx-auto md:w-3/5 mt-1 md:p-10 sm:p-2 rounded">
		...
		<form action="{{ route('management-system-reviews.store') }}" method="POST" autocomplete="off" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
			...
			<div class="mb-4">
				...
				<textarea class="appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="participants" name="participants" required oninvalid="this.setCustomValidity('{{__("Popunite polje")}}')" oninput="this.setCustomValidity('')">{{ old('participants') }}</textarea>
				@error('participants')
					<span class="text-red-700 italic text-sm">{{ $message }}</span>
				@enderror
			</div>
			...
			<div class="mb-4">
				...
				<textarea class="appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="measures_status" name="measures_status" required oninvalid="this.setCustomValidity('{{__("Popunite polje")}}')" oninput="this.setCustomValidity('')">{{ old('measures_status') }}</textarea>
			...
			<div class="mb-4">
				...
				<textarea class="appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="internal_external_changes" name="internal_external_changes" required oninvalid="this.setCustomValidity('{{__("Popunite polje")}}')" oninput="this.setCustomValidity('')">{{ old('internal_external_changes') }}</textarea>
			...
			<div class="mb-4">
				<label for="customer_satisfaction" class="block text-gray-700 text-sm font-bold mb-2">{{__('Potrebe i očekivanja zainteresovanih strana i obaveze za usklađenost')}}t:</label>
			...
			<div class="mb-4">
				...
				<textarea class="appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="monitoring_measurement_results" name="monitoring_measurement_results" required oninvalid="this.setCustomValidity('{{__("Popunite polje")}}')" oninput="this.setCustomValidity('')">{{ old('monitoring_measurement_results') }}</textarea>
			...
			<div class="mb-4">
				...
				<textarea class="appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="checks_results_desc" name="checks_results_desc" required oninvalid="this.setCustomValidity('{{__("Popunite polje")}}')" oninput="this.setCustomValidity('')">{{ old('checks_results_desc') }}</textarea>
			...
			<div class="mb-4">
				...
				<textarea class="appearance-none border w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="communication_and_objections" name="communication_and_objections" required oninvalid="this.setCustomValidity('{{__("Popunite polje")}}')" oninput="this.setCustomValidity('')">{{ old('communication_and_objections') }}</textarea>
