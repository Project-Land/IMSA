        ...
        <div class="col">
            ...
            <div class="card">
                <div class="card-header">
                    <a class="btn btn-info" href="{{ route('compliance-correction.create') }}"><i class="fas fa-plus"></i> Kreiraj novi dokument</a>
                </div>
                            ...
                            @foreach($documents as $document)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href='{{ asset("storage/compliance_correction/$document->file_name") }}'><i class="fas fa-download"></i></a>
                                        <a href="{{ route('compliance-correction.edit', $document->id) }}"><i class="fas fa-edit"></i></a>
                                        <form class="inline" action="{{ route('compliance-correction.destroy', $document->id) }}" method="POST">
                                            @method('DELETE')
                                            @csrf
