<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ session('standard_name') }} - {{ __('Neusaglašenosti i korektivne mere') }} - {{ __('Kreiraj novi dokument') }} 
        </h2>
    </x-slot>
    ...
    <div class="mx-auto w-50 mt-10 bg-secondary p-10 rounded">
		...
		<form action="{{ route('compliance-correction.store') }}" method="POST" enctype="multipart/form-data">
			@csrf
