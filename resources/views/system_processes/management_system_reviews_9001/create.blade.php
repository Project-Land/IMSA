<x-app-layout>
    ...
    <div class="mx-auto md:w-3/5 mt-1 md:p-10 sm:p-2 rounded">
		...
		<form action="{{ route('management-system-reviews.store') }}" method="POST" autocomplete="off" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
			...
			<div class="mb-4">
				<label for="customer_satisfaction" class="block text-gray-700 text-sm font-bold mb-2">{{ __('Zadovoljstvo korisnika i povratne informacije zainteresovanih strana')}}:</label>
			...
			<p class="text-lg">{{ __('Performanse procesa i usaglašenost proizvoda i usluga')}}</p><hr>
			...
			<div class="mb-4">
				<label for="improvement_opportunities" class="block text-gray-700 text-sm font-bold mb-2">{{__('Prilike za poboljšanje')}}:</label>
			...
			<div class="mb-4">
				<label for="needs_for_resources" class="block text-gray-700 text-sm font-bold mb-2">{{ __('Potrebe za resursima')}}:</label>
