        ...
        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <a class="inline-block text-xs md:text-base bg-blue-500 hover:bg-blue-700 text-white hover:no-underline rounded py-2 px-3" href="{{ route('accidents.create') }}"><i class="fas fa-plus"></i> {{__('Kreiraj istraživanje incidenta')}}</a>
                </div>
                @endcan
                        ...
                        <table class="table table-bordered yajra-datatable">
                            <thead>
                                <tr class="text-center">
                                    <th>{{__('Datum')}}</th>
                                    <th>{{__('Ime i prezime povređenog radnika')}}</th>
                                    <th>{{__('Tip povrede')}}</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <a data-toggle="tooltip" data-placement="top" title="{{__('Pregled izveštaja')}}" class="button text-primary cursor-pointer" onclick="showAccident({{ $accident->id }})"><i class="fas fa-eye"></i></a>
                                        ...
                                        <a data-toggle="tooltip" data-placement="top" title="{{__('Izmena istraživanja incidenta')}}" href="{{ route('accidents.edit', $accident->id) }}"><i class="fas fa-edit"></i></a>
                                        <form class="inline" id="delete-form-{{ $accident->id }}" action="{{ route('accidents.destroy', $accident->id) }}" method="POST">
                                            @method('DELETE')
                                            @csrf
                                            <button type="button" class="text-red-600 cursor-pointer hover:text-red-800" data-toggle="tooltip" data-placement="top" title="{{__('Brisanje istraživanja incidenta')}}" onclick="confirmDeleteModal({{ $accident->id }})"><i class="fas fa-trash"></i></button>
                                        </form>
                                        @endcanany
                                    </td>
                                </tr>
    ...
    <div class="modal fade" id="confirm-delete-modal" tabindex="-1" role="dialog" aria-labelledby="delete-modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="px-6 py-4">
                    <div class="text-lg">{{__('Brisanje istaživanja incidenta')}}</div>
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header text-center">
                                            <h5 class="modal-title font-weight-bold">Izveštaj</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row text-sm">
                                                ...
                                                <div class="col-sm-5 mt-3 border-bottom font-weight-bold"><p>{{ __('Datum i vreme povrede') }}</p></div>
                                                ...
                                                <div class="col-sm-5 mt-3 border-bottom font-weight-bold"><p>{{ __('Uzrok povrede') }}</p></div>
                                                <div class="col-sm-7 mt-3 border-bottom"><p>${ response.data.injury_cause }</p></div>
                                                <div class="col-sm-5 mt-3 border-bottom font-weight-bold"><p>{!! __('KRATAK OPIS POVREDE <br>(kako je došlo do povrede – u fazama)') !!}</p></div>
                                                ...
                                                <div class="col-sm-5 mt-3 border-bottom font-weight-bold"><p>{!! __('Podaci o neposrednom rukovodiocu povređenog<br>- Ime prezime i radno mesto') !!}</p></div>
                                                <div class="col-sm-7 mt-3 border-bottom"><p>${ response.data.supervisor }</p></div>

                                                <div class="col-sm-5 mt-3 border-bottom font-weight-bold"><p>{{ __('Datum/vreme prijave povrede') }}</p></div>
