                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 mt-3 mt-md-0">
                            <form id="formYear" class="form-inline" method="get" action="{{ asset('/internal-check/get-data') }}">
                                ...
                                <select id="year"  class="appearance-none w-1/3 sm:w-1/4 text-xs sm:text-base mr-2 block border border-gray-200 text-gray-700 py-2 px-3 pr-8 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        ...
                        <a id="excelBtn" class="inline-block float-right text-xs md:text-base bg-green-500 hover:bg-green-700 text-white hover:no-underline rounded py-2 px-3" href="{{ '/internal-check-export'.'?year='.session('year') }}"><i class="fas fa-file-export"></i> {{ __('Excel') }}</a>
                        </div>
                    </div>
                </div>
                                ...
                                <tr id='trinternalcheck{{$check->id}}'><a id='internalcheck{{$check->id}}'></a>
                                    ...
                                    <td class="text-center">
                                        @if(!isset($check->internalCheckReport->id))
                                            ...
                                            @endif
                                        @else
                                            <span data-toggle="tooltip" data-placement="top" title="{{ __('Pregled izveštaja sa interne provere') }}" class="reportShow cursor-pointer text-blue-700 hover:text-blue-900" data-url="{{ route('internal-check-report.show', $check->internalCheckReport->id) }}"><i class="fas fa-eye"></i></span>
                                    ...
                                    <td class="text-center">
                                            <a
                                                href="{{route('internal-check.print',$check->id)}}" target="_blank" data-toggle="tooltip" data-placement="top" class="text-green-400 hover:text-green-600" title="{{__('Odštampaj')}}" ><i class="fas fa-print"></i>
                                            </a>
                                        @can('update', $check)
