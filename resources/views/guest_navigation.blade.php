<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16 mt-2">
            ...
            <div class="flex justify-end">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    ...
                    <a href="{{ route('lang',['lang'=>'rs']) }}"><img src="{{asset('images/sr.png')}}" class="mx-2"/></a>
                    <a href="{{ route('lang',['lang'=>'en']) }}"><img src="{{asset('images/en.png')}}"/></a>
                </div>
    ...
    <a href="{{ route('lang',['lang'=>'rs']) }}"><img src="{{asset('images/sr.png')}}" class="mr-2 inline-block float-right"/></a>
    </x-jet-responsive-nav-link>
