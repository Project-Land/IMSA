        ...
        <div class="flex justify-between h-16 mt-2">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex text-lg p-4">
                    ...
                    <x-jet-dropdown>
                        <x-slot name="trigger">
                            <button type="button" class="hover:no-underline hover:text-gray-700 text-base hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out" style="@if(request()->is(['/','standards*'])) {{'border-bottom:3px solid gray'}} @endif" >{{ __('Standardi') }}</a>
                        </x-slot>
                    ...
                    <x-jet-dropdown>
                        <x-slot name="trigger">
                            <button type="button" class="hover:text-gray-700 text-base hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out" style="@if(request()->is(['rules-of-procedures*','manuals*','policies*','forms*','procedures*','external-documents*','other-internal-documents*'])) {{'border-bottom:3px solid gray; border-radius: 0;'}} @endif">{{ __('Dokumentacija') }}</button>
                        </x-slot>
                    ...
                    <x-jet-dropdown>
                        <div class="dropdown-menu">
                            <x-slot name="trigger">
                                <button type="button" class="hover:text-gray-700 text-base hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out" style="@if(request()->is(['sectors*'])) {{'border-bottom:3px solid gray; border-radius: 0;'}} @endif">{{ __('Sektori') }}</button>
                            </x-slot>
                            ...
                            <x-slot name="content">
                                ...
                                @can('create', App\Models\Sector::class)
                                    <a class="block px-4 py-2 text-sm leading-5 hover:no-underline text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out" href="{{ asset('/sectors/create') }}">{{ __('Dodaj sektor') }}</a>
                                @endcan
                            </x-slot>
                        </div>
                    </x-jet-dropdown>
