...
class ManagementSystemReviews9001Export implements FromQuery, WithHeadings, ShouldAutoSize, WithStyles, WithColumnWidths, WithProperties, WithMapping
{
    use Exportable;
    ...
    public function headings(): array
    {
        return [
            ...
            __('Zadovoljstvo korisnika i povratne informacije zainteresovanih strana'),
            ...
            __('Performanse eksternih isporučilaca'),
    ...
    {
        $sheet->getStyle('A1:Q1')->getBorders()->getAllBorders()->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THICK);
        $sheet->getStyle('A2:Q2')->getBorders()->getAllBorders()->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
        $sheet->getStyle('A2:Q2')->getAlignment()->setIndent(1);
    ...
    public function map($msr): array
    {
        return [
            ...
            $msr->external_suppliers_performance,
