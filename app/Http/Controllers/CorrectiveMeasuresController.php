...
class CorrectiveMeasuresController extends Controller
{
    ...
    public function store(CorrectiveMeasuresRequest $request)
    {
        ...
        try{
            ...
            $request->session()->flash('status', array('info', 'Korektivna mera je uspešno sačuvana'));
        } catch(Exception $e){
    ...
    public function update(CorrectiveMeasuresRequest $request, $id)
    {
        ...
        try{
            ...
            $request->session()->flash('status', array('info', 'Korektivna mera je uspešno izmenjena'));
        } catch(Exception $e){
